...
public sealed partial class RentLivingEditPage : Page
{


    public RentLivingEditViewModel ViewModel
    {
        get;
    }

    public RentLivingEditPage()
    {
        ViewModel = App.GetService<RentLivingEditViewModel>();
        InitializeComponent();
