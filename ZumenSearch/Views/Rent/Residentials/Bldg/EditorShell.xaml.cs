...
public sealed partial class EditorShell : Page
{
    ...
    public EditorShell(Views.Rent.Residentials.Bldg.EditorWindow win, ViewModels.Rent.Residentials.ResidentialsViewModel vm, IModalDialogService modalDialog)
    {
