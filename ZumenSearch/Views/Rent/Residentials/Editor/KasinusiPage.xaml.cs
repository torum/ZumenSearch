    ...
    public ViewModels.Rent.Residentials.Editor.EditorViewModel? ViewModel
    {
        ...
        private set
        {
            if (_editorShell != null)
            {
                ...
                {
                    Debug.WriteLine("Views.Rent.Residentials.Editor.KasinusiPage ViewModel is null!");
                }
            }
            else
            {
                Debug.WriteLine("Views.Rent.Residentials.Editor.KasinusiPage _editorShell is null!");
            }
        }
    }
