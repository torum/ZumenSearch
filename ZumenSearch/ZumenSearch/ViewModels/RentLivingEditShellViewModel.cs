...
public class RentLivingEditShellViewModel : ObservableRecipient, INavigationAware
{
    ...
    public RentLivingEditShellViewModel(INavigationService navigationService, INavigationViewService navigationViewService)
    {
