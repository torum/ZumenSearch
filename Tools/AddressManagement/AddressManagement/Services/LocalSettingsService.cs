...
using AddressManagement.Core.Helpers;
using AddressManagement.Helpers;
...
{
    private const string _defaultApplicationDataFolder = "AddressManagement/ApplicationData";
