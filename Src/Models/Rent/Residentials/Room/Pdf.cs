...
public sealed partial class Pdf : PdfBase
{
    ...
    public readonly ObservableCollection<RoomPdfType> RoomPdfTypes =
        ...
        new RoomPdfType(Models.Rent.Residentials.Room.EnumRoomPdfType.Maisoku),
        new RoomPdfType(Models.Rent.Residentials.Room.EnumRoomPdfType.Architectural),
        new RoomPdfType(Models.Rent.Residentials.Room.EnumRoomPdfType.Other)
        ];
