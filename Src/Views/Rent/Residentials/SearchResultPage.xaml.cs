...
public sealed partial class SearchResultPage : Page
{
    ...
    private void SearchResult_DoubleTapped(object sender, Microsoft.UI.Xaml.Input.DoubleTappedRoutedEventArgs e)
    {
        ...
        if (container.DataContext is not Models.Rent.Residentials.ListingSearchResultItem searchresult)
        {
        ...
        if (ViewModel.EditRentResidentialRoomCommand.CanExecute(searchresult))
        {
            ViewModel.EditRentResidentialRoomCommand.Execute(searchresult);
        }
    }
    ...
    private void ItemContainer_RightTapped(object sender, Microsoft.UI.Xaml.Input.RightTappedRoutedEventArgs e)
    {
        ...
        if (container.DataContext is not Models.Rent.Residentials.ListingSearchResultItem)
        {
    ...
    private void ItemsViewKeyboardAccelerator_Invoked(Microsoft.UI.Xaml.Input.KeyboardAccelerator sender, Microsoft.UI.Xaml.Input.KeyboardAcceleratorInvokedEventArgs args)
    {
        ...
        if (element.DataContext is not Models.Rent.Residentials.ListingSearchResultItem searchresult)
        {
